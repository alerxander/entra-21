...
public class Formulario extends JFrame {
	...
	public Formulario() {
		...
		txtClassificação.setBounds(78, 98, 113, 20);
		contentPane.add(txtClassificação);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				jogo.setClassificacao(txtClassificação.getText());
		...
		btnalterar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				j.setClassificacao(txtClassificação.getText());
